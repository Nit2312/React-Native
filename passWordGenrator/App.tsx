...
const passwordschema = Yup.object().shape({
  passwordLength: Yup.number().min(4, 'Should have a min of 4 characters')
...
export default function App() {
  ...
  const generatedPasswordString = (passwordLength: number) => {
    ...
    const lowerCasechars = 'abcdefghijklmnopqrstuvzxyz';
      ...
      <SafeAreaView style={styles.appContainer}>
        ...
        {isPassGenerated ? (
          <View style={[styles.card, styles.cardElevated]}>
            <Text style={styles.subTitle}>Restult:</Text>
